...
</br>In the image shown above it is clearly visible that how branches resides on top of each other. After certain number of commits I have created a new branch named "my_branch" as follows;</br> git branch my_branch </br>

Now our 'Head' is pointing towards our new branch which is represented as * just because I have passed a command;</br> git checkout my_branch </br>
